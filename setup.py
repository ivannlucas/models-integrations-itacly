...
setup(
    ...
    name='itacyl-pan-modelsinference-svc',  # Required
    ...
    keywords='clustering protocol_metrics previous utm',  # Optional
    ...
    data_files=[('data', ['requirements.txt'])],  # Optional
