"""Vendored verbatim (logic unchanged) from inbox/a45/codigo/src/data_processing/input_validation.py.

Only the logger wiring was adapted (get_logger() -> logging.getLogger(__name__)).
"""
