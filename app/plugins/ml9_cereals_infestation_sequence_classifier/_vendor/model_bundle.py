"""VENDORED verbatim from the a09 delivery — src/utils/model_bundle.py.

Resolves the runtime config against the training snapshot stored in model_bundle_metadata.json and
enforces that the 65 engineered features match the trained model's expected order. No deviations.
"""
