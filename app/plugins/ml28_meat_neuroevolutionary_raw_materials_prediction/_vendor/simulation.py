"""Vendored verbatim from inbox/a28/codigo/src/simulation/policy_simulation.py.

Only the import of compute_policy_metrics was adapted to point at the vendored metrics.py in
this same package.
"""
...
from app.plugins.ml28_meat_neuroevolutionary_raw_materials_prediction._vendor.metrics import (
