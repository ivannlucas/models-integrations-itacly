...
|:-------:|:-------------------|:------------:|
:-----------------------------|
| v0.1.53 | 16/06/2026         | Alejandro Flores | feat: integrate ml2-fungal-cnn-disease-detection plugin (LeafCNN, /train→501); flake8 cleanup + remove vendored source folder; update ADDING_A_MODEL.md & CLAUDE.md |  
